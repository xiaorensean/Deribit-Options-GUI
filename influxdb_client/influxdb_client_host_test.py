...
HOST_test = "ec2-99-79-47-186.ca-central-1.compute.amazonaws.com"

# database name
database = 'md_rates'


class InfluxClientHostTest:
    
    def __init__(self):        
        user_name = ''
        passwords = ''         
        self.client = InfluxDBClient(host=HOST_test, port=8086, username=user_name, password=passwords)
...
if __name__ == '__main__':
    ...
    #query = db.query_tables(tables[1]['name'],["*","order by time limit 1"])
    #db.delete('binance_orderbook_futures',"2018-08-28 00:02:02",None)
